...
<html><head>
<meta charset="utf-8">
<title>Samsung Galaxy A5 (2017)</title>
...
<link rel="stylesheet" href="css/style_a5.css">
...
<div class="container " style="background-color: white">
	<div class="row">
		<div class="col-xs-12">
			<div class="tieu_de">
				<h2>Samsung Galaxy A5 (2017) </h2>
				<span>(No.00317644)</span>
			</div>
		</div>
				...
				<!--<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/ss_a5.jpg" class="img-responsive" class="wm-zoom-default-img"  alt="alternative text" data-hight-src="images/ss_a5.jpg">
						</div>
					</div>
				</article>		-->	  			
					<img id="img_01" src="images/ss_a5.jpg" data-zoom-image="images/ss_a5.jpg" class="img-responsive" />			
			</div>
		</div>
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">5.2 inch (1080 x 1920 pixels )</span>
					</li>
					<li>
						<label>Pin:</label>
						<span> Pin chuẩn Li-Ion 3000 mAh</span>	
					</li>
					<li>
						<label>CPU :</label>
						<span> Exynos 7880, 8 Nhân, <br> 1.9 GHz</span>
					</li>
				</ul>
			</div>			
			<div class="thong_tin_2 margin_top_20" style="margin-left: 10px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 16.0 MP; Phụ: 16.0 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 3 GB</span>	
		...
		<div  class="col-lg-5 col-md-5 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<div id="gallery_01">
					<div class="chon_mau">
						<h3>Chọn màu: </h3>
						<a href="javascript:void(0)" data-image="images/ss_a5.jpg" data-zoom-image="images/ss_a5.jpg"  width="300px">
							<div class="mau"></div>
						</a>
						<a href="javascript:void(0)" data-image="images/a5_x.jpg" data-zoom-image="images/a5_x.jpg"  width="300px">
								<div class="mau_1"></div>
						</a>	
						<a href="javascript:void(0)" data-image="images/a5_v.jpg" data-zoom-image="images/a5_v.jpg"  width="300px">
							<div class="mau_2"></div>
						</a>	
						<a href="javascript:void(0)" data-image="images/ạ.jpg" data-zoom-image="images/ạ.jpg"  width="300px">
							<div class="mau_3"></div>
						</a>	
					</div>
				</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của Samsung Galaxy A5 (2017)</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về Samsung Galaxy A5 (2017)</h2>
				<div class="inform_tt">
					<ul>
						<li>
							<a href="#"><img src="images/a5_1.jpg" class="img-responsive">
								<h3>5 smartphone bán chạy nhất Việt Nam trong tháng 8</h3>
							</a>
						</li>
						<li>
							<a href="#"><img src="images/a5_2.jpg " class="img-responsive h_1">
								<h3>Galaxy A5 (2017) nhận bản cập nhật mới, thêm tính năng xóa phông cho camera selfie</h3>
							</a>							
						</li>
						<li>
							<a href="#"><img src="images/a5_3.jpg " class="img-responsive h_1">
								<h3>5 Điều người dùng cần lưu ý để có bức ảnh hoàn hảo cùng Samsung Galaxy A5 (2017)</h3>
							</a>							
						</li>
						<li>
							<a href="#"><img src="images/a5_4.jpg " class="img-responsive h_1">
								<h3>Đánh giá Galaxy A5 (2017) sau 2 tháng: camera xuất sắc trong tầm giá, pin trâu, hiệu năng tốt</h3>
							</a>					
