...
<div class="container bg_inform">
	<div class="row">
		<div class="col-xs-12 m_header">
			<ul class="ul_header">
				<li><a href="index.php">Trang chủ / </a> </li>
				<li ><a href="dienthoai.php" class="li_ul"> Điện thoại </a></li>
			</ul>
		</div>
		<div class="col-lg-3">
			<div class="hang_xs">
				<h2>Hãng sản xuất</h2>
				<input type="text" class="form-control" placeholder="Tìm thương hiệu"> <span class="glyphicon glyphicon-search"></span>
				<ul class="ul_sx">
		...
		<div class="col-lg-9 hang_r">
			<ul>	
				<li class="li_r">
					<div class="col-lg-3">
						<img src="images/camera_oppo.jpg">
					</div>
					<div class="col-lg-9 inform_r">
						<h3>
							<a href="oppo_f3.php">
								OPPO F3 Plus
							</a>
						...
						<ul class="ul_gia">
							<li>
								<label style="font: inherit">Màn Hình:</label>
								<span> 6.0 inch (1080 x 1920 pixels)</span>
							</li>
							<li>
								<label style="font: inherit">Pin:</label>
								<span> Li-Ion 4000 mAh</span>
							</li>
							<li>
								<label style="font: inherit">CPU :</label>
								<span> Qualcomm Snapdragon 653, 8 Nhân</span>
							</li>

						</ul>
						<ul class="ul_gia_r">
							<li>
								<label style="font: inherit">Camera:</label>
								<span>Chính: 16.0 MP, Phụ: Dual 16.0 MP + 8.0 MP</span>
							</li>
							<li>
								<label style="font: inherit">Ram:</label>
								<span>4 GB</span>
							</li>
							<li>
								<label style="font: inherit">HĐH :</label>
				...
				<li class="li_r">
					...
					<div class="col-lg-9 inform_r">
						...
						<ul class="ul_gia">
							...
							<li>
								<label style="font: inherit">Pin:</label>
								<span>Li-Ion 3200 mAh</span>
							</li>
							<li>
								<label style="font: inherit">CPU :</label>
								<span>MediaTek MT6750T, 8 Nhân,1.51 Ghz</span>
							</li>

						</ul>
						<ul class="ul_gia_r" style="padding-left: 65px">
							<li>
								<label style="font: inherit">Camera:</label>
								<span> Chính: 13.0 MP, Phụ: Dual 16.0 MP + 8.0 MP</span>
							</li>
							<li>
								<label style="font: inherit">Ram:</label>
								<span>4 GB</span>
							...
							<li>
								<label style="font: inherit">HĐH :</label>
								<span>ColorOS 3.0, nền tảng Android 6.0</span>
							</li>
				...
				<li class="li_r">
					...
					<div class="col-lg-9 inform_r">
						...
						<ul class="ul_gia" style="margin-left: 20px">
							<li>
								<label style="font: inherit">Màn Hình:</label>
								<span> 5.5 inch (1920 x 1080 pixels)</span>
							</li>
							...
							<li>
								<label style="font: inherit">CPU :</label>
								<span>Exynos 7870, 8 Nhân, Octa-core 1.6 GHz</span>
							</li>

						</ul>
						<ul class="ul_gia_r" style="padding-left: 45px">
							<li>
								<label style="font: inherit">Camera:</label>
								<span>Chính: 13.0 MP, Phụ: 16.0 MP</span>
							</li>
							<li>
								<label style="font: inherit">Ram:</label>
								<span>4 GB</span>
				...
				<li class="li_r">
					...
					<div class="col-lg-9 inform_r">
						...
						<ul class="ul_gia" style="margin-left: 20px" >
							<li>
								<label style="font: inherit">Màn Hình:</label>
								<span> 5.2 inch ( 1280 x 720 pixels)</span>
							</li>
							<li>
								<label style="font: inherit">Pin:</label>
								<span> Li-Ion 3000 mAh</span>
							</li>
							<li>
								<label style="font: inherit">CPU :</label>
								<span> Mediatek MT6750, 8 Nhân, 1.5 GHz Octa-Core</span>
							</li>

						</ul>
						<ul class="ul_gia_r"  style="padding-left: 20px">
							<li>
								<label style="font: inherit">Camera:</label>
								<span>Chính: 13.0 MP, Phụ: 5.0 MP</span>
							</li>
							<li>
								<label style="font: inherit">Ram:</label>
								<span>3 GB</span>
