...
<!-- //map -->
    ...
    <div class="content_bottom">
       <?php
            ...
            ?>
            <table class="tb"><thead><tr><th>Mã Đơn Hàng</th><th>IMEI</th><th>Tên dòng điện thoại</th><th>Màu Sắc</th><th>Số Lượng</th><th>Đơn Giá</th><th>Thành Tiền</th><th>Thao Tác</th></tr></thead>
                <?php
                foreach($data as $r)
                {
                    ?>
