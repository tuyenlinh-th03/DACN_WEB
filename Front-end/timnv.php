...
<body>
<div id="wrapper" style="width: 140%">
     <!-- Navigation -->
...
<!-- //map -->
    ...
    <div class="content_bottom">
       <?php
            ...
            <table  align="center">
            &nbsp;&nbsp;<input type="text" name="ts" placeholder="Nhập tên nhân viên" />&nbsp;&nbsp;
            ...
            ?>
            <table class="tb"><thead><tr><th>Mã nhân viên</th><th>Tên nhân viên</th><th>User Name</th><th>Mật khẩu</th><th>Ngày sinh</th><th>Giới tính</th><th>Quyền truy cập</th><th>Địa chỉ</th><th>SĐT</th><th>Thao tác</th></tr></thead>
                <?php
                foreach($data as $r)
                {
                    ?>
                    <tr><td> <?php echo $r["MaNV"]; ?></td>
