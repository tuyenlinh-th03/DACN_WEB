	...
	<div class="row">
		...
		<div class="col-lg-9 hang_r">
			<ul>	
				<li class="li_r">
					<div class="col-lg-3">
						<img src="images/oppo_f3_plus.jpg">
					</div>
					<div class="col-lg-9 inform_r">
						...
						<ul class="ul_gia">
							...
							<li>
								...
								<span> Snapdragon 435 8 nhân, 2.3 GHz</span>
							</li>

						</ul>
						<ul class="ul_gia_r" style="padding-left: 100px;">
							<li>
								<label style="font: inherit">Camera:</label>
								<span>13 MP, Selfie: 16 MP</span>
							</li>
							<li>
				...
				<li class="li_r">
					...
					<div class="col-lg-9 inform_r">
						...
						<ul class="ul_gia" style="margin-left: 3px">
							<li>
								<label style="font: inherit">Màn Hình:</label>
						...
						<ul class="ul_gia_r" style="padding-left: 75px">
							<li>
								<label style="font: inherit">Camera:</label>
				...
				<li class="li_r">
					...
					<div class="col-lg-9 inform_r">
						...
						<ul class="ul_gia" style="margin-left: 21px">
							<li>
								<label style="font: inherit">Màn Hình:</label>
								<span> 5.5 inch (1920 x 1080 pixels)</span>
							</li>
