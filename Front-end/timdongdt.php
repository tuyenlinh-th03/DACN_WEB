...
<title>Danh sách dòng điện thoại</title>
...
<!-- //map -->
    ...
    <div class="content_bottom">
       <?php
        ...
        <form action="timdongdt.php" method="post">
        <table  align="center">
        &nbsp;&nbsp;<input type="text" name="ts" placeholder="Nhập tên dòng DT"/>&nbsp;&nbsp;
        ...
        ?>
        <table class="tb"><thead><tr><th>Mã dòng DT</th><th>Mã loại</th><th>Mã hãng SX</th><th>Mã NCC</th><th>Tên dòng DT</th><th>Hình ảnh</th><th>Đơn giá</th><th>Giá KM</th><th>Thao tác</th></tr></thead>
            <?php
            foreach($data as $r)
            { ?>
                <tr><td> <?php echo $r["MaDongDT"]; ?></td>
                <td><?php echo $r["MaLoai"]; ?></td>
                <td><?php echo $r["MaHangSX"]; ?></td>
                <td><?php echo $r["MaNCC"]; ?></td>
                <td><?php echo $r["TenDongDT"]; ?></td>
                <td>
                    <img src="images/<?php echo $r["Hinh"]; ?>"/>
                </td>
