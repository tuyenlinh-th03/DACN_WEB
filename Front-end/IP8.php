...
<html><head>
<meta charset="utf-8">
<title>iPhone 8 Plus 64GB </title>
...
<link rel="stylesheet" href="css/style_ip8.css">
</head>
<body>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="tieu_de">
				<?php
		        $obj = new Dongdt();
		        $data = $obj->getOne('IP05');
		        foreach ($data as $r) {
		       
				?>
				<h2><?php echo $r['TenDongDT']; ?></h2>
				<span>(No.00269762)</span>
			</div>
		</div>
				...
				<!--<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/ip7_256.jpg" class="img-responsive" class="wm-zoom-default-img"  alt="alternative text" data-hight-src="images/ip7_256.jpg">
						</div>
					</div>
				</article>		-->	  	
				<img id="img_01" src="images/ip7_256.jpg" data-zoom-image="images/ip7_256.jpg" class="img-responsive" />		
			</div>
		</div>
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">5.5 inchs HD Retina</span>
					</li>
					<li>
						<label>Pin:</label>
						<span>	2675 mAh</span>	
			...
			<div class="thong_tin_2 margin_top_20" style="margin-left: 10px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: Dual 12.0 MP, Phụ: 7.0 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 3 GB</span>	
		...
		<div  class="col-lg-5 col-md-5 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<!--	<h3>CHƯƠNG TRÌNH KHUYẾN MẠI ĐẶC BIỆT ĐẾN 22/10:KHÁCH HÀNG CHỌN 1 TRONG 2 KHUYẾN MẠI SAU:</h3>
					...
					<ul type="disc">
						...
						<li>Trả góp 0%/ Trả thẳng + Giảm ngay 5.500.000đ khi mua máy kèm gói cước FPT588 + Tặng Kính Samsung Gear VR 2017 New</li>
					</ul>
					<!--<div class="clear"></div>
					<h2>KM2:</h2>
					<ul type="disc">
				...
				<div id="gallery_01">
					<div class="chon_mau">
						<h3>Chọn màu: </h3>
						<a href="javascript:void(0)" data-image="images/i8_den.jpg" data-zoom-image="images/i8_den.jpg" >
							<div class="mau"></div>
						</a>
						<a href="javascript:void(0)" data-image="images/i8_v.jpg" data-zoom-image="images/i8_v.jpg" >
							<div class="mau_1"></div>
						</a>
						<a href="javascript:void(0)" data-image="images/i8_t.jpg" data-zoom-image="images/i8_t.jpg" >
							<div class="mau_2"></div>
						</a>
					</div>
				</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của iPhone 8 Plus 64GB</h3>
			<div class="thong_tin">
				...
				<ul class="show_tt">
					...
					<li>
						...
						<span>	GSM/EDGE (850, 900, 1800, 1900 MHz)</span>
					</li>
				</ul>
			</div>
		</div> 
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về iPhone 8 Plus 64GB</h2>
				<div class="inform_tt">
					<ul>
						<li>
							<a href="#"><img src="images/ip7_1.png" class="img-responsive">
								<h3>iPhone 7, iPhone 7 Plus đồng loạt giảm giá như chưa từng được giảm</h3>
							</a>
						</li>
						<li>
							<a href="#"><img src="images/ip7_2.png" class="img-responsive h_1">
								<h3>iPhone 8 sắp lên kệ, iPhone 7 giảm giá kịch sàn</h3>
							</a>							
						</li>
						<li>
...
<!-- getlink bl<?phpechoget_permalink(); ?> -->
<div class="container">
