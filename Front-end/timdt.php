...
<!-- //map -->
    ...
    <div class="content_bottom">
       <?php
        ...
        $obj = new Dt();
        ?>
        <form action="timdt.php" method="post">
        <table  align="center">
        &nbsp;&nbsp; <input type="text" name="ts" placeholder="Nhập mã dòng DT"/>&nbsp;&nbsp;
        ...
        ?>
        <table class="tb"><thead><tr><th>Mã IMEI</th><th>Mã dòng điện thoại</th><th>Màu sắc</th><th>Thao tác</th></tr></thead>
            <?php
            foreach($data as $r)
            {
                ?>
                <tr><td><?php echo $r["IMEI"];?></td>
