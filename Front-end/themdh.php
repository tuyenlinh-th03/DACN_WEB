    ...
    <div class="content_bottom">
        <?php
            ...
            if (isset($_POST["Submit"]))
            {
                ...
                $nh= $_POST['nh'];
                $tt= $_POST['tt'];
                $data = $obj->insert($ma, $manv, $makh, $tenkh, $sdt, $nl, $nh, 0, $tt);
                echo "<p style='color:#4CAF50;'>Đã thêm đơn hàng thành công!</p>";  
            }
            $a= $o3->getAll();
            $b= $o4->getAll();
            ?>
            ...
            <fieldset class="fs">
            <legend class="lg" style="width: 310px">Nhập thông tin đơn hàng cần thêm</legend>
            <form action="themdh.php" method="post">
            <table  align="center">
                <tr><td>Mã Đơn Hàng :</td><td><input type="text" name="ma" maxlength="10" disabled></td></tr>
                ...
                <tr><td>Tổng Thành Tiền :</td><td><input type="number" name="ttt" required step="0.001" disabled></td></tr>
