...
<!-- //map -->
    ...
    <div class="content_bottom">
       <?php
            ...
            ?>
            <table class="tb"><thead><tr><th>Mã Đơn Hàng</th><th>Mã Nhân Viên</th><th>Mã Khách Hàng</th><th>Tên Khách Hàng</th><th>Số Điện Thoại</th><th>Ngày lập</th><th>Ngày Hẹn Nhận</th><th>Tổng Thành Tiền</th><th>Trạng Thái</th><th>Thao tác</th></tr></thead>
                <?php
                foreach($data as $r)
                {
                    ?>
