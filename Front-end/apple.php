...
<div class="container bg_inform">
	<div class="row">
		<div class="col-xs-12 m_header">
			<ul class="ul_header">
				<li><a href="dienthoai.php">Trang chủ / </a> </li>
		...
		<div class="col-lg-9 hang_r">
			<ul>	
				<li class="li_r">
					<div class="col-lg-3">
						<img src="images/636440019397912479_iPhone 7 Plus 128GB.jpg">
					</div>
				...
				<li class="li_r">
					<div class="col-lg-3">
						<img src="images/636440012253892479_iPhone 7 Plus 32GB.jpg" width="181px">
					</div>
					<div class="col-lg-9 inform_r">
						...
						<ul class="ul_gia" style="margin-left: -13px;">
							<li>
								<label style="font: inherit">Màn Hình:</label>
							...
							<li>
								<label style="font: inherit">CPU :</label>
								<span>Apple A10, 4 Nhân, Quad-core 2.3 GHz</span>
							</li>

						</ul>
						<ul class="ul_gia_r" style="padding-left: 80px;">
							<li>
								<label style="font: inherit">Camera:</label>
								<span>Chính: Dual 12.0 MP, Phụ: 7.0 MP</span>
							</li>
							<li>
								<label style="font: inherit">Ram:</label>
								<span>3 GB</span>
				...
				<li class="li_r">
					<div class="col-lg-3">
						<img src="images/636439140749162217_1o.png" width="181px">
					</div>
					<div class="col-lg-9 inform_r">
						<h3 style="margin-left: -13px;">
							<a href="IP6s_32.php">
						...
						<ul class="ul_gia" style="margin-left: -13px;">
							...
							<li>
								<label style="font: inherit">CPU :</label>
								<span>Apple A9, 2 Nhân, Dual-core 1.8 GHz</span>
							</li>

						</ul>
						<ul class="ul_gia_r" style="padding-left: 90px;">
							<li>
								<label style="font: inherit">Camera:</label>
								<span>Chính: Dual 12.0 MP, Phụ: 7.0 MP</span>
							</li>
				...
				<li class="li_r">
					...
					<div class="col-lg-9 inform_r">
						...
						<ul class="ul_gia" style="margin-left: -3px;"">
							<li>
								<label style="font: inherit">Màn Hình:</label>
								<span> 4.7 inch (1334 x 750 pixels)</span>
							</li>
							<li>
								<label style="font: inherit">Pin:</label>
							...
							<li>
								<label style="font: inherit">CPU :</label>
								<span>Apple A8 2 nhân 64-bit, 2 Nhân, 1.4 GHz</span>
							</li>
