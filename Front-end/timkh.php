...
<!-- //map -->
    ...
    <div class="content_bottom">
       <?php
            ...
            <table  align="center">
            &nbsp;&nbsp;<input type="text" autofocus name="ts" placeholder="Nhập tên khách hàng"/>&nbsp;&nbsp;
            ...
            ?>
            <table class="tb"><thead><tr><th>Mã khách hàng</th><th>Tên khách hàng</th><th>Email</th><th>Mật khẩu</th><th>Ngày sinh</th><th>Địa chỉ</th><th>SĐT</th><th>Thao tác</th></tr></thead>
                <?php
                foreach($data as $r)
                {
                    ?>
                    <tr><td> <?php echo $r["MaKH"]; ?></td>
