...
<?php
                ...
                {  
                    ...
                    {  
                            ...
                            else
                            {
                                    ...
                                    $data = $ob->update($ma, $imei1, $ten, $ms, $sl, $dg, $d[0]['ThanhTien']);
                                    ...
                                    $data = $ob->update($ma, $imei, $ten, $ms, $sl, $dg, $d[0]['ThanhTien']);
                                    header("location:timctdh.php");
            ...
            ?>
            <fieldset class="fs">
            <legend class="lg">Nhập thông tin chi tiết đơn hàng cần sửa</legend>
            ...
            <tr><td>Số Lượng : </td><td><input type="number" name="sl" required value="<?php echo $v["SoLuong"];?>" /></td></tr>
             ...
             <tr><td>Thành Tiền : </td><td><input type="number" required step="0.001" name="ttt" value="<?php echo $v["ThanhTien"];?>" disabled /></td></tr>
             <?php
            }
            ?>
