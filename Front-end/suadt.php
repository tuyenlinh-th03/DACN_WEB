...
<!-- //map -->
    ...
    <div class="content_bottom">
        <?php
            ...
            ?>
            <fieldset class="fs">
            <legend class="lg" style="width: 320px">Nhập thông tin điện thoại cần sửa</legend>
            <form action="suadt.php" method="post">
            <table  align="center">
                <?php
                foreach ($o2 as $v) {
                    ?>
                <tr><td>Mã IMEI:</td><td><input type="number" name="ma" disabled value="<?php echo $v["IMEI"];?>"></td></tr>
