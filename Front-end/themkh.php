       ...
       <?php
            ...
            if (isset($_POST["Submit"]))
            {
                ...
                foreach($q as $v)
                {
                    if($v['Email']==$em)
                    {
                        echo "<p style='color:red;'>Email bị trùng! Vui lòng nhập email khác!</p>";
            ...
            <body>
            <fieldset class="fs">
            <legend class="lg" style="width: 330px">Nhập thông tin khách hàng cần thêm</legend>
            <form action="themkh.php" method="post">
            <table  align="center">
                <tr><td>Mã khách hàng :</td><td><input type="text" name="ma" maxlength="10" disabled></td></tr>
