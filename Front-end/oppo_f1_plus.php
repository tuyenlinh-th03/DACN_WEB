...
<link rel="stylesheet" href="css/style_of1.css">
</head>
<body>
	...
	<div class="row">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="background-color: white">
			<div class="image">
				...
				<img id="img_01" src="images/o1_1.jpg" data-zoom-image="images/o1_1.jpg" class="img-responsive" />	  			
			</div>
		</div>
			...
			<div class="thong_tin">
				...
				<ul class="show_tt">
					...
					<li>
						...
						<span>	151.8 x 74.3 x 6.6 mm</span>
					</li>
					<li>
						<label>CPU : </label>
