...
<link rel="stylesheet" href="css/style_n8.css">
	...
	<div class="row">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="background-color: white">
			<div class="image">
				<!--<article class="body">
					...
					<img id="img_01" src="images/n8_1_1.jpg" data-zoom-image="images/n8_1_1.jpg" class="img-responsive" />			
			</div>
		</div>
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">6.3 inch</span>
					</li>
					<li>
						<label>Pin:</label>
						<span> 	Li-Ion</span>	
					...
					<li>
						<label>CPU :</label>
						<span>Lõi Tám (lõi Tứ 2.3GHz + lõi <br> Tứ 1.7GHz)</span>
					</li>
				</ul>
			</div>			
			<div class="thong_tin_2 margin_top_20" style="margin-left: 10px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">	Chính: Dual 12.0 MP, Phụ: 8.0 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 6 GB</span>	
		...
		<div  class="col-lg-5 col-md-5 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<div id="gallery_01">
					<div class="chon_mau">
						<h3>Chọn màu: </h3>
						<a href="javascript:void(0)" data-image="images/n8_1_3.jpg" data-zoom-image="images/n8_1_3.jpg"  width="300px">
							<div class="mau"></div>
						</a>
						<a href="javascript:void(0)" data-image="images/n8_1_2.jpg" data-zoom-image="images/n8_1_2.jpg"  width="300px">
								<div class="mau_1"></div>
						</a>	
					</div>
				</div>
			...
			<div class="thong_tin">
				...
				<ul class="show_tt">
					...
					<li>
						...
						<span>162.5 x 74.8 x 8.6 mm</span>
					</li>
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				...
				<div class="inform_tt">
					<ul>
						<li>
							<a href="#"><img src="images/n8_1.jpg" class="img-responsive">
								<h3>7 điện thoại thông minh cao cấp tốt nhất năm 2017 mà bạn nên biết</h3>
							</a>
						</li>
						<li>
							<a href="#"><img src="images/n8_2.jpg " class="img-responsive h_1">
								<h3>Samsung đánh bại Apple ngay trên sân nhà. IPhone X doanh số chỉ bằng một nửa Note8</h3>
							</a>							
						</li>
						<li>
							<a href="#"><img src="images/n8_3.jpg " class="img-responsive h_1">
								<h3>Khởi động nhanh Samsung Pay chỉ với một cái chạm cảm biến vân tay</h3>
							</a>							
						</li>
						<li>
							<a href="#"><img src="images/n8_4.jpg " class="img-responsive h_1">
								<h3>Galaxy Note8 - chiếc Galaxy Note có pin xuất sắc nhất trong lịch sử</h3>
							</a>					
