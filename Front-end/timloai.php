...
<!-- //map -->
    ...
    <div class="content_bottom">
       <?php
            ...
            <form action="timloai.php" method="post">
            <table  align="center">
            &nbsp;&nbsp; <input type="text" name="ts" placeholder="Nhập tên loại DT"/>&nbsp;&nbsp;
            ...
            ?>
            <table class="tb"><thead><tr><th>Mã loại điện thoại</th><th>Tên loại điện thoại</th><th>Thao tác</th></tr></thead>
                <?php
                foreach($data as $r)
                {
                    ?>
                    <tr><td> <?php echo $r["MaLoai"]; ?></td>
