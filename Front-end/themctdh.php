        ...
        <?php
            ...
            if (isset($_POST["Submit"]))
            {
                ...
                foreach($q as $v)
                {
                    ...
                    {
                        $data = $obj->insert($ma, $imei, $ten, $ms, $sl, $dg, NULL);
                    }
                }
            ...
            ?>
            <fieldset class="fs">
            <legend class="lg" style="width: 385px">Nhập thông tin chi tiết đơn hàng cần thêm</legend>
            ...
            <table  align="center">
                ...
                <tr><td>Thành Tiền :</td><td><input type="number" name="ttt" required step="0.001" disabled></td></tr>
