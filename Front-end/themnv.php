...
<!-- //map -->
    ...
    <div class="content_bottom">
       <?php
            ...
            ?>
            <fieldset class="fs">
            <legend class="lg" style="width: 310px">Nhập thông tin nhân viên cần thêm</legend>
            <form action="themnv.php" method="post">
            <table  align="center">
                <tr><td>Mã nhân viên :</td><td><input type="text" name="ma" maxlength="10" disabled></td></tr>
