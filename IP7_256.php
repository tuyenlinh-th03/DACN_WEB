...
<link rel="stylesheet" href="css/style_ip7_256.css">
</head>
<body>
	...
	<div class="row">
		...
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					...
					<li>
						<label>Pin:</label>
						<span>Li-Ion 11.1 Wh (2900 mAh)</span>	
					</li>
					<li>
						<label>CPU :</label>
						<span>  Apple A10, 4 Nhân, Quad-core <br> 2.3 GHz</span>
					</li>
				</ul>
			</div>			
		...
		<div  class="col-lg-5 col-md-5 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<div id="gallery_01">
					<div class="chon_mau">
						<h3>Chọn màu: </h3>
						<a href="javascript:void(0)" data-image="ip7_256.jpg" data-zoom-image="ip7_256.jpg"  width="300px" >
							<div class="mau"></div>
						</a>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của iPhone 7 256GB</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về iPhone 7 256GB</h2>
				<div class="inform_tt">
					<ul>
						<li>
