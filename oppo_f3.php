		...
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">  6.0 inch (1080 x 1920 pixels)</span>
					</li>
					<li>
						<label>Pin:</label>
						<span> Qualcomm Snapdragon 653, 8 </span>	
					</li>
					<li>
						<label>CPU :</label>
						<span>  Qualcomm Snapdragon 653, 8 Nhân,<br> 2.3 GHz</span>
					</li>
				</ul>
			</div>			
			<div class="thong_tin_2 margin_top_20" style="margin-left: 10px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 16.0 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 4 GB</span>	
		...
		<div  class="col-lg-5 col-md-5 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<div id="gallery_01">
					<div class="chon_mau">
						...
						<a href="javascript:void(0)" data-image="images/oppo_f3_plus.jpg" data-zoom-image="images/oppo_f3_plus.jpg"  width="300px" >
							<div class="mau_2"></div>
						</a>	
				<!--		<a href="#">
							<div class="mau_3"></div>
