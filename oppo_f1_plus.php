...
<link rel="stylesheet" href="css/style_o_f3.css">
</head>
<body>
			...
			<div class="logo">
			  ...
			  <div class="header_top_right">
			   ...
			   <div class="login">
			    ...
			    <a href="dangky.php"><button class="btn btn-default"><span class="glyphicon glyphicon-off"></span> Đăng ký</button>
	 		</div>
	 	</div>
	  </div>
  </div>
	...
	<div class="row">
				...
				<!--<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/oppo_f1_plus.jpg" class="img-responsive" class="wm-zoom-default-img"  alt="alternative text" data-hight-src="images/oppo_f1_plus.jpg">
						</div>
					</div>
				</article>	-->	
				<img id="img_01" src="images/oppo_f1_plus.jpg" data-zoom-image="images/oppo_f1_plus.jpg" class="img-responsive" />	  			
			</div>
		</div>
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					...
					<li>
						<label>Pin:</label>
						<span> Li-ion 2850 mAh </span>	
					</li>
					<li>
						<label>CPU :</label>
						<span>  MediaTek MT6755, 8 Nhân, Octa-core<br> 2.0 GHz</span>
					</li>
				</ul>
			</div>			
			<div class="thong_tin_2 margin_top_20" style="margin-left: 10px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 13.0 MP, Phụ: 16.0 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 4 GB</span>	
					...
					<li>
						<label>HĐH:</label>
						<span>Android 5.1 (Marshmallow) </span>
					</li>
				</ul>
			</div>					
		</div>
		<div  class="col-lg-5 col-md-5 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<!--	<h3>CHƯƠNG TRÌNH KHUYẾN MẠI ĐẶC BIỆT ĐẾN 22/10:KHÁCH HÀNG CHỌN 1 TRONG 2 KHUYẾN MẠI SAU:</h3>
					<h2>KM1:</h2>-->
					<ul type="disc">
						<li>Trả góp 0% (Trả trước 10%) Hoặc Giảm ngay 1,000,000đ</li>
						<li>Giảm ngay 200,000đ khi mua thẻ nhớ 32GB/Loa nấm</li>
						<li>Cơ hội trúng ĐTDĐ Oppo F5 Hoặc Xe Vespa</li>
					</ul>
					<!--<div class="clear"></div>
					<h2>KM2:</h2>
					<ul type="disc">
						...
						<li>Giảm 35% Phần mềm diệt virus Eset Mobile khi mua <a href="#">Xem chi tiết</a></li>
					</ul>-->
				</div>
				<div id="gallery_01">
					<div class="chon_mau">
						...
						<a href="javascript:void(0)" data-image="images/oppo_f1_plus.jpg" data-zoom-image="images/oppo_f1_plus.jpg"  width="300px">
								<div class="mau_1"></div>
						</a>
						<a href="javascript:void(0)" data-image="images/o1_plus.jpg" data-zoom-image="images/o1_plus.jpg"  width="300px">
							<div class="mau_2"></div>
						</a>	
				<!--		<a href="#">
							<div class="mau_3"></div>
				...
				<div class="col-lg-12 col-md-12 col-sm-6 col-zs-12 mua_hang_1" style="margin-top: 20px;">
					<div class="dat_hang">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 dat_hang_2">
							<button>THÊM VÀO<br><span>GIỎ HÀNG</span> 
							</button>
						</div>
					</div>
			...
			<div class="tab-content" style="margin-top: 20px">
				<div role="tabpanel" class="tab-pane active" id="home">
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/ip7_k.png">
							<h5>iPhone 8 64GB</h5>
							<strong>20.990.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của OPPO F1 Plus</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về OPPO F1 Plus</h2>
				<div class="inform_tt">
					<ul>
						<li>
							<a href="#"><img src="images/oppo_1.jpg" class="img-responsive">
								<h3>Có 13 triệu trong tay, chọn mua smartphone nào là hợp lý nhất?</h3>
							</a>
						</li>
						<li>
							<a href="#"><img src="images/oppo_2.jpg" class="img-responsive h_1">
								<h3>Smartphone màn hình 6”, chip Snapdragon 653, camera selfie kép, ngày cuối cùng giảm giá mạnh</h3>
							</a>							
						</li>
						<li>
							<a href="#"><img src="images/ip7_3.png" class="img-responsive h_1">
								<h3>Apple ngưng bán iPhone 7 256GB để dễ bán iPhone 8 hơn</h3>
							</a>							
						</li>

						<li>
							<a href="#"><img src="images/a5_4.jpg " class="img-responsive h_1">
								<h3>Phải chăng smartphone cao cấp đang ngày càng trở nên mắc tiền hơn?</h3>
							</a>					
