	...
	<div class="header">
		<div class="header_top">
			...
			<div class="logo">
			  ...
			  <a href="dangky.php"><button class="btn btn-default"><span class="glyphicon glyphicon-off"></span> Đăng ký</button></a>
	 		</div>
	 	</div>
	  </div>
  </div>
	...
	<div class="row content_1">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="SS_J7Pro.php">
				...
				<strong class="tien">6.990.000₫</strong>
				<div class="coupon">
					<span>Trả góp 0%</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Samsung Galaxy J7 Pro</span>
					<strong>6.990.000₫</strong>
					<div class="promotion">
						<span> Áo khoác (Nếu không có quà sẽ hoàn 100,000đ)</span>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<h3 style="margin-top: 20px">Vivo V7+</h3>
				<strong class="tien">7.990.000₫</strong>
				<figure class="content_figure">
					<span class="slogan">Vivo V7+</span>
					<strong>7.990.000₫</strong>
					<span>Màn hình: 5.99", HD</span>
					<span>HĐH: Android 7.1</span>
					<span>CPU: Qualcomm Snapdragon 450</span>
					<span>RAM: 4 GB, ROM: 64 GB</span>
					<span>Camera: 16 MP, Selfie: 24 MP</span>
					<span>PIN: 3225 mAh</span>
				</figure>
			</a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<h3 style="margin-top: 20px">Loa Bluetooth Amethyst </h3>
				<strong class="tien">594.000₫</strong>
				<div class="coupon" style="background-color: limegreen">
					<span class="giam">Giảm 20%</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Loa Bluetooth Amethyst </span>
					<strong>594.000₫</strong>
					<span>Kiểu dáng khối vuông, có quai xách tiện tợi.</span>
					<span>Có thể kết nối bằng bluetooth,dây cắm 3.5 mm</span>
					<span>Có thể nhận và nghe gọi trực tiếp trên loa.n</span>
					<span>Công nghệ bluetooth 4.0 giúp kết nối tới 10 m.</span>
					<span>Pin 2.200 mAh, chơi nhạc 12 giờ, sạc 4 giờ.</span>
				</figure>
			</a>
		</div>
	</div>
	...
	<div class="row content_1">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<strong class="tien">22.990.000₫</strong>
				<div class="coupon">
					<span>Trả góp 0%</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">iPhone 7 Plus 128GB </span>
					<strong>22.990.000₫</strong>
					<div class="promotion">
						<span> Tặng phiếu mua hàng trị giá 1,000.000đ</span>
						<span>  Cơ hội trúng xe Honda SH150i </span>
					</div>
					<span>Màn hình: 5.5", Retina HD</span>
					<span>HĐH: iOS 10</span>
					<span>CPU: Apple A10 Fusion 4 nhân</span>
					<span>RAM: 3 GB, ROM: 128 GB</span>
					<span>Camera: 2x12 MP, Selfie: 7 MP</span>
					<span>PIN: 2900 mAh, SIM: 1 SIM</span>
				</figure>
			</a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<h3 style="margin-top: 20px">Samsung Galaxy J7+</h3>
				<strong class="tien">8.690.000₫</strong>
				<div class="coupon">
					<span>Trả góp 0%</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Samsung Galaxy J7+</span>
					...
					<span>Camera: 13 MP và 5 MP (2 camera) </span>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<h3 style="margin-top: 20px">Sony Xperia XA1 Plus</h3>
				<strong class="tien">7.190.000₫</strong>
				<figure class="content_figure">
					<span class="slogan">Sony Xperia XA1 Plus</span>
					<strong>7.190.000₫</strong>
					<div class="promotion">
						<span> Ốp lưng trong suốt </span>
						<span>  Cơ hội trúng Tivi PREMIUM TV OLED 65"</span>
					</div>
					<span>Màn hình: 5.5", Full HD</span>
					<span>HĐH: Android 7.0</span>
					<span>CPU: Mediatek Helio P20</span>
					<span>RAM: 4 GB, ROM: 32 GB</span>
					<span>Camera: 23 MP, Selfie: 8 MP</span>
					<span>PIN: 3430 mAh</span>
				</figure>
			</a>
		</div>
	</div>
